...
@RestController
@RequestMapping("/api/compte-kafka")
public class CompteKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CompteKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CompteKafkaResource(KafkaProperties kafkaProperties) {
